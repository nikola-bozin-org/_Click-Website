...
const Intro = () => {
  return (
    <div className='intro'>
        ...
        <p  style={{textAlign:'center'}} data-aos-delay="100" data-aos="fade-up" className="ultimativni">E-Sports</p>
        <p  style={{textAlign:'center'}} data-aos-delay="100" data-aos="fade-up" className="ultimativni">Centar!</p>
        </div>
    </div>
  )
}
