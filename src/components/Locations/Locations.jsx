...
const Locations = () => {
  ...
  return (
    <div style={{color:'white'}} ref={lokacijeRef} className='locations'>
      ...
      <p data-aos='fade-in' style={{marginTop:'50px',fontSize:'30px', textAlign:'center'}} className="VidimoSe">Rezervisi svoje mesto na vreme!</p>
      <p data-aos='fade-in' style={{marginTop:'0px',fontSize:'30px', textAlign:'center'}} className="VidimoSe">+381637520646</p>
